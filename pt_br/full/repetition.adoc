...
In <<selection#selection>>, you learned tools that allow you to do
...
end. To leave a loop abruptly, you can use the `break` command. Note that the
`break` command exists in many languages, but it should be used rarely, if at
all, to leave a loop.
...
.Binary Conversion
====
As we discussed in <<computer-basics#computer-basics>>, binary numbers
