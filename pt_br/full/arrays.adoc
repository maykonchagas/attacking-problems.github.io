...
With one exception, all the types we've talked about in this book
...
simulation. In <<gui#gui>> you'll learn how to make a graphical user interface (GUI)
...
We'll explain this code in much greater detail in <<concurrency#concurrency>>.
...
in <<dynamic-data-structures#dynamic-data-structures>>.
...
going to talk about it in depth in <<file-io#file-io>>, but for
...
multiple times would be tedious. When we get to <<file-io#file-io>>,
