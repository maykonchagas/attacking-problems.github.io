[#synchronization]
:imagesdir: chapters/synchronization/images
:programsdir: chapters/synchronization/programs
== Synchronization
...
centers on the statement `{plus}{plus}counter` in the `for` loop inside the
...
`{plus}{plus}counter` is *not* a single step. Recall that `{plus}{plus}counter` is shorthand
...
operation is one which happens in a single step and cannot be interrupted by a
context switch to another thread. The actual code that the JVM runs is much
...
recall the thread state diagram from <<concurrency#concurrency>>,
...
[source, java]
----
include::{programsdir}/SynchronizedAccount.java[lines=5..17]
----
...
[source, java]
----
include::{programsdir}/SynchronizedAccount.java[lines=19..34]
----
...
[source, java]
----
include::{programsdir}/SynchronizedAccount.java[lines=36..47]
----
...
Researchers have discovered four conditions which must exist for
deadlock to happen.
...
[source, java]
----
include::{programsdir}/DeadlockPhilosopher.java[lines=26..35]
----
...
[source, java]
----
include::{programsdir}/DeadlockPhilosopher.java[lines=37..56]
----
...
one of the most common and problematic issues with carelessly using
synchronization.
...
[source, java]
----
include::{programsdir}/DeadlockSum.java[lines=9..20]
----
...
[source, java]
----
include::{programsdir}/DeadlockSum.java[lines=22..24]
----
...
[source, java]
----
include::{programsdir}/DeadlockSum.java[lines=26..53]
----
...
[source, java]
----
include::{programsdir}/Livelock.java[lines=10..24]
----
...
[source, java]
----
include::{programsdir}/Livelock.java[lines=26..48]
----
...
In <<concurrency#concurrency>> we suggest that you rarely use
...
[source, java]
----
include::{programsdir}/DiningPhilosopher.java[lines=28..43]
----
...
[source, java]
----
include::{programsdir}/DiningPhilosopher.java[lines=45..61]
----
...
[source, java]
----
include::{programsdir}/DiningPhilosopher.java[lines=63..71]
----
