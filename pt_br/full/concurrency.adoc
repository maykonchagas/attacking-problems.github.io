...
that problem will be addressed in <<synchronization#synchronization>>.
...
we'll discuss in <<synchronization#synchronization>>.
...
parallelism, but applying this solution to problems which can
...
problem. None of the solutions we give here is fully acceptable. We
