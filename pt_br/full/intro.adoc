...
implementing them in Java, but <<testing-and-debugging#testing-and-debugging>>
...
https://www.oracle.com/technetwork/java/javase/downloads[Oracle downloads site^]. Download a current
version (e.g., JDK 21 or JDK 22) of the Java Platform,
...
Three of the most popular Java IDEs are Eclipse, IntelliJ IDEA, and Visual Studio Code.  Eclipse is open-source, free, and available https://www.eclipse.org[here^].  Visual Studio Code is also free and has many extensions available for Java development. You can download it https://code.visualstudio.com[here^].  Although some versions of IntelliJ IDEA cost money, the Community edition of IntelliJ IDEA is free and available https://www.jetbrains.com/idea/[here^].
...
<<testing-and-debugging#testing-and-debugging>>, in which we briefly discuss
...
<<gui-basics#gui-basics>>. Then, we go into
GUIs in much more depth in <<gui#gui>>.
...
change. We'll discuss types more deeply in <<strings-primitive-types#strings-primitive-types>>.
...
<<strings-primitive-types#strings-primitive-types>>. Here are examples of
...
further in <<testing-and-debugging#testing-and-debugging>>.
